...
MEDIA_ROOT = '/Users/raymond/Programming/djblog/static_media'
...
SECRET_KEY = 'tudm=mq1f8^y@*6$ghj(geu0k0o^^oe!t8mc3dty7zesdh^$^)'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/Users/raymond/Programming/djblog/templates',
)
